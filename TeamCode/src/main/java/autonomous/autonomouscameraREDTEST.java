...
public class autonomouscameraREDTEST extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        rightWheel.setPositionPIDFCoefficients(-10);
        ...
        cameraTest camera = new cameraTest(hardwareMap,this); //TODO להכין אחד כזה לצד הכחול
        waitForStart();
        ...
        while (opModeIsActive()){
            ...
            telemetry.addData("PID", leftWheel.getPIDFCoefficients(DcMotor.RunMode.RUN_TO_POSITION));
            telemetry.update();
        }
        //driveY(-50,0.5);
